  ...
  return (
    ...
    <div className="h-screen w-1/5 bg-gray-200 fixed">
      ...
      <div className="flex flex-col items-start pl-4">
        ...
        <div className="pt-3 w-4/5 p-2 hover:bg-white transition duration-300 ease-in-out rounded-lg">
          ...
          <a href="#" className="font-bold text-base ml-2">Data Jabatan</a>
        </div>
        <div className="pt-3 w-4/5 p-2 hover:bg-white transition duration-300 ease-in-out rounded-lg">
          <FontAwesomeIcon icon={faCalendarDays} style={{ color: "#000000" }} />
    ...
    <div className="w-4/5 ml-[20%]">
      ...
      <div className="flex mt-20 justify-center">
        <div className="card w-[57rem] h-36 ml-8 mr-6 pr-6 bg-gray-200 flex flex-col rounded-xl uppercase">
        ...
        <table className=" w-[57.5rem] rounded-lg">
          <thead className="bg-blue-600 text-white">
            <tr>
                ...
                <th className="p-3 tracking-wide text-left">Jabatan</th>
          ...
          <tbody>
            <tr className="bg-white">
              ...
              <button className="bg-red-500 px-3 py-1 w-16 text-white focus:outline-none rounded-md">Hapus</button>
              </td>
            </tr>
            <tr className="bg-gray-200">
              <td className="p-3 text-sm text-gray-700">Ceo</td>
